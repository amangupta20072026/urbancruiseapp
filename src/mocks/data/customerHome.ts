...
const AMAN_HOME: MockHomeData = {
  ...
  upcomingTrip: {
    ...
    /* Driver not yet assigned — swaps to the driver's name/phone
     * once assignment happens, closer to the trip date. */
    driverDetailsNote: 'Driver details available tomorrow',
  },

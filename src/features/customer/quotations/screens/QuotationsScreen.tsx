 ...
 * ------------------------------------------------------------------
 * Landing screen for the Customer "Quotations" tab. Currently a
 * ComingSoon placeholder; when the real UI ships (quotation list +
 * comparison + accept/reject CTAs), replace the ComingSoon body
  ...
  return (
    <SafeScreen edges={['top']}>
      <View style={styles.headerWrap}>
        <ScreenHeader
          title="Quotations"
          subtitle="Compare and manage your travel quotations."
        />
      </View>
